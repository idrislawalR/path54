  ...
  return (
    <div className="container-shell">
      ...
      <RevealGroup className="mt-12 grid min-w-0 gap-4 md:mt-16 md:grid-cols-12" stagger={0.16}>
        ...
        />
        <RevealItem className="flex aspect-[388/426] min-w-0 items-center border border-[#2A2A2A] bg-[#2A2A2A]/30 p-[clamp(28px,4.7vw,64px)] md:col-span-7 md:aspect-[795/527]" y={36}>
